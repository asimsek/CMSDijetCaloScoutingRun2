...
#usage = "python DrawFromTree_data4.py --var mjj --xmin 1 --xmax 14000 --xtitle 'Dijet mass [GeV]' --bins 13999 --outputDir CaloScoutingHT2018ALL_Data_05Dec2019_1748/ --inputList_1 CaloScoutingHT2018ALL-v1_reduced.txt --inputMC QCDMC4_2017.txt --lumi 58830 --logy --rebin -1 --units GeV"
...
baseCut = '!(run >= 321712 && run <= 322040) && TMath::Abs(deltaETAjj) < 1.3 && mjj > ' + str(minX_mass)
