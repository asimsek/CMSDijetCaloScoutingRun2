...
set outputFitFolder="fits_${date}_${year}_DE13_M${mass}_w2016Signals/${config}_${configFile}"
#set inputmjj="histo_data_mjj_scaled_${year}.root"
#set inputmjj="inputs/CaloScoutingHT${year}_DatavsQDCMC_DE13_M489_wL2L3Residual_12March2021_1930/histo_data_mjj_fromTree.root"
...
#set inputmjj="inputs/CaloScoutingHT${year}ALL_DatavsQDCMC_DE13_M489_17June2021_1130/histo_data_mjj_fromTree.root"
...
set signalShapes="inputs/ResonanceShapes_gg_13TeV_CaloScouting_Spring16.root,inputs/ResonanceShapes_qg_13TeV_CaloScouting_Spring16.root,inputs/ResonanceShapes_qq_13TeV_CaloScouting_Spring16.root"
set outputLimitFolder="AllLimits${year}_${signalType}_${configFile}"
...
python python/BinnedFit.py -c config/${configFile}.config -l ${lumi} --mass 750_1200_1600 -m gg_qg_qq --xsec 9.5_8.2e-1_2.2e-1 -s ${signalShapes} ${inputmjj} -b ${config} -d ${outputFitFolder}/ --fit-spectrum
